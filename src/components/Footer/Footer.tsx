...
export function Footer({
  ...
  // Default copyright
  const defaultCopyright = copyright?.html || copyright?.text || '© Crown copyright'
      ...
      <div className={containerClassName}>
        ...
        <div className="govuk-footer__meta">
          <div className="govuk-footer__meta-item govuk-footer__meta-item--grow">
            ...
            <span className="govuk-footer__licence-description">{defaultContentLicence}</span>
          </div>
